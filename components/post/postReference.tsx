...
const PostReferenceSection = (props: IPost) => {
  ...
  return (
    <section key={_key} className="borderstyle rounded-lg shadow-lg overflow-hidden relative h-40">
      {mainImage && <Image src={mainImage.asset.url} fill={true} quality={90} placeholder='blur' loading='lazy' blurDataURL={mainImage.asset.url} className="w-full object-cover" alt="" />}
